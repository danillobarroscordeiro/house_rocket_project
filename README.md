...
1) Region (zip code), condition type and season were the most influential variables of property price.
...
The dataset used to deal with this case was available at [Kraggle](https://www.kaggle.com/code/lucascapovilla/house-rocket/data). 
...
* Minimum_selling_price - Minimum selling price for that property
* Suggested_selling_price - Suggested_selling_price for that property
* Minimum_profit - Minimum profit company would make selling that house
* Expected_profit - Expected Profit company would make selling house
* Max_improvement_cost - The maximum cost company should spend in renovating a house
* Min_profit_margin - Minimum profit margin company would make selling that house
...
True. In fact, renovated good condition properties are 26% more expensive than the not renovated ones. This means that the company could acquire some non renovated houses, make some improvements on them that cost at most 13% of their selling price, for instance.
...
To define for how much the property would be sold, it was considered two scenarios, a minimum selling price and a suggested selling price:

* Minimum Selling Price
  1) **If it is a bad condition house which is renovated, the selling price would be the 40th decile of good properties buying price of its region, considering the season which the house will be sold as well.**
  2) **If it is a regular condition house, the selling price would be the median of regular properties buying price of its region, considering the season which the house will be sold as well.**
  3) **If it is a good condition house, the selling price would be the median of good properties buying price of its region, considering the season which the house will be sold as well.**

* Suggested Selling Price
  1) **If it is a bad condition house which is renovated, the selling price would be the median of good properties buying price of its region, considering the season which the house will be sold as well.**
  2) **If it is a regular condition house, the selling price would be the 60th decile of regular properties buying price of its region, considering the season which the house will be sold as well. In case there is no regular condition properties on sold in some region, will be considered the 40th decile of good condition properties buying prices of this region.**
  3) **If it is a good condition house, the selling price would be the 60th decile of good properties buying price of its region, considering the season which the house will be sold as well. In case there is no good condition properties on sold in some region, will be considered the 3rd quantile of regular condition properties buying prices of this region.**
...
A dashboard is hosted in a streamlit app in an AWS server, so company would find out the best opportunities using specific filters such as price and zip code. 

Below one can see this dashboard:

![](/figures/gif.gif)

## Next steps

* Making a ranked machine learning algorithm to detect more precisely which properties company should buy.
* Making a regression machine learning algorithm to define more precisely for how many properties should be sold.
